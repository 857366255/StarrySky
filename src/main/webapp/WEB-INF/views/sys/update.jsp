                                            ...
                                            <div class="col-sm-9 input-group">
                                                <c:choose>
                                                    <c:when test="${it.select_map!=null && it.select_map!=''}">
                                                        <select class="form-control m-b" name="${it.name_en}">
                                                            ...
                                                            <c:forEach items="${it.select_map}" var="sg">
                                                                <c:choose>
                                                                    <c:when test="${data[it.name_en].equals(sg.key)}">
                                                                        <option value="${sg.key}" selected = "selected"><c:forEach items="${sg.val}"  var="val">${val}&nbsp</c:forEach></option>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <option value="${sg.key}"><c:forEach items="${sg.val}"  var="val">${val}&nbsp</c:forEach></option>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </c:forEach>
                                                        </select>
                                                    ...
                                                    <c:when test="${it.is_disable}">
                                                        <input name="${it.name_en}" type="${it.input_type}" placeholder="" disabled="" class="form-control" value="${data[it.name_en]}"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <input name="${it.name_en}" type="${it.input_type}" placeholder="${it.hint}" class="form-control" value="${data[it.name_en]}"/>
                                                    </c:otherwise>
                                                </c:choose>
